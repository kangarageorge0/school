...
class crown extends panel {
    ...
    async get_paginator_data() {
        ...
        if (this.query.factors.crown.length === 0)
            return [];
        //
...
class matrix extends panel {
    ...
    constructor(sheet) {
        ...
        //
        //Set the body element from the web page
        this.element = this.get_element('matrix');
        //
...
class header extends panel {
    ...
    get pivots() {
        ...
        if (this.query.factors.crumb.length === 0)
            return [];
        //
    ...
    get_crumb_cell_ids(factor, index) {
        ...
        */
        ...
        const ancestors = this.query.factors.crumb.slice(0, index + 1);
        //
    ...
    generate_cells(previous_cells, factor, index) {
        ...
        const levels = this.query.levels[factor];
        //
    ...
    show_top_row() {
        ...
        const anchor = { element: tr, page: this.sheet };
        //
    ...
    show_pivot_row(index) {
        ...
        const factor = this.sheet.query.factors.crumb[index];
        //
        //Add as many crumb cells as there are cell ids for the factor that 
    ...
    //region
    factors_start_drag(ev, region, index) {
        //
...
class body extends panel {
    ...
    async show() {
        ...
        const data = await this.query.get_body_data();
        //
...
class cell extends view.view {
    ...
    constructor(parent, cell_type, io_type, colspan, text, id) {
        ...
        const anchor = { element: this.td, page };
        //
...
class filter extends panel {
    ...
    show() {
        ...
        if (this.query.levels === undefined)
