...
export class crosstab extends view.view{
    ...
    constructor(
        ...
        ...
        In this case, grading is the body query 
        */
        public body_cte:string,
        //
        //The name of the cte in the base query that identifies the factors to
        //be cross tabled. In the case of the exam, it is this percent cte. 
    ...
    update_factors_ondrop(ev:DragEvent,dest_key:region_type,dest_index:number){
        ...
        const src_key:region_type = <region_type>ev.dataTransfer!.getData('region');
        //
