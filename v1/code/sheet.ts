...
class crown extends panel{
    ...
    public filters_element:HTMLLegendElement;
    //
    ...
    constructor(sheet:sheet){
        ...
        this.filters_element = <HTMLLegendElement>this.get_element('filters');
        //
    ...
    public async show():Promise<void>{
        ...
        this.filters = this.factors.crown.map((factor,index)=>
            new filter(this, factor, index, this.filters_element)
        );
        //
        //Show the paginator
...
class draggable extends panel{
    ...
    async on_drop(ev:DragEvent, to:region_type, index:number){
        //
        ...
        const from:region_type = <region_type>ev.dataTransfer!.getData('region');
        //
        //The crown need not be repainted if it is not affected by the drop
        if (![from, to].includes('crown')) await this.sheet.matrix.show();
        //
...
class filter extends draggable{
    ...
    //
    //Provide deeper details for the parent element
    declare  parent:crown;
    //
    constructor(
        //
        parent:crown,
    ...
    //paginator data. 
     update_value(){
         ...
         const paginator_index: number = this.sheet.crown.paginator.selector.selectedIndex
         //
...
class paginator extends panel {
    ...
    constructor(private crown:crown){
        ...
        this.selector = <HTMLSelectElement>this.get_element('paginator');
        //
